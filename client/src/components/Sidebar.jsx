                ...
                <div className="h-full px-6 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul className="space-y-3 font-medium">
                        <li>
                            <a
                                href="#"
                                className="flex items-center px-20 py-10 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                                <svg
                                ...
                                <span className="ms-5 text-xl">Home</span>
                            </a>
                        </li>
                        <li>
                            <button
                                ...
                                aria-expanded={isDropdownOpenCategory}
                            ...
                            >
                                ...
                                <svg
                                    className={`w-3 h-3 transform transition-transform ${
                                        isDropdownOpenCategory ? "rotate-180" : ""
                                    }`}
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                            ...
                            <ul id="dropdown-category" className={`py-2 space-y-2 ${isDropdownOpenCategory ? "block" : "hidden"}`}>
                                <li>
                                    <a
                                        href="#"
                        ...
                        <li>
                            <button
                                ...
                                aria-expanded={isDropdownOpenCondition}
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Condition</span>
                                <svg
                                    className={`w-3 h-3 transform transition-transform ${
                                        isDropdownOpenCondition ? "rotate-180" : ""
                                    }`}
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                            ...
                            <ul id="dropdown-condition" className={`py-2 space-y-2 ${isDropdownOpenCondition ? "block" : "hidden"}`}>
                                <li>
                                    <a
                                        href="#"
                                        className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
