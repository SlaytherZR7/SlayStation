export const Card = ({ name, price, quantity, photo }) => {
  return (
    <div classNameName='w-64 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
      <a href='#'>
        <img classNameName='p-8 rounded-t-lg' src={photo} alt={name} />
      </a>
